...
Generated by Postal on 2014/06/20", output);
    ...
    <body>
        ...
        EmailViewResult Create(string template, string textTemplate = null, string htmlTemplate = null)
        {
            ...
            renderer.Setup(r => r.Render(email, null, null)).Returns(template);
            if(!string.IsNullOrEmpty(textTemplate))
                renderer.Setup(r => r.Render(email, "~/Views/Emails/Test.Text.cshtml", null)).Returns(textTemplate);
            if (!string.IsNullOrEmpty(htmlTemplate))
                renderer.Setup(r => r.Render(email, "~/Views/Emails/Test.Html.cshtml", null)).Returns(htmlTemplate);
